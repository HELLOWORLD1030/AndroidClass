...
public class Lab42Adapter extends RecyclerView.Adapter<Lab42Adapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public Lab42Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Lab42Adapter.ViewHolder holder, int position) {
